-- Portal users should see every case/errand where they are connected as the
-- person client or as an active representative of the entity client.
-- Per-activity and per-document visibility remains controlled separately.
