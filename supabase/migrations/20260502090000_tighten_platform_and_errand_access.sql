...
-- sales_admin may operate commercial/platform metadata screens, but must not
-- inherit super_admin access to confidential firm records at the database layer.
...
-- Errands need explicit staff assignment, mirroring cases.
...
-- Preserve existing assignments in the new team table.
...
-- Firm admins see all errands. Other staff, including accountants and
-- secretaries, see only errands they are assigned to.
...
-- Replace broad org-member errand access with assignment-aware access.
...
-- Invoices and payments stay visible to firm_admin/accountant org-wide, and to
-- assigned matter staff for the matter they work on.
...
-- Portal clients must be able to access visible documents attached to errands.
