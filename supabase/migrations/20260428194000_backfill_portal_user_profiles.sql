-- Portal users need matching role=client profile rows for tables that still
-- use profile foreign keys, such as documents.uploaded_by.
-- AuthContext treats role=client profiles as portal identities, not staff.
